...
function updateMaxLines(maxTokens) {
  const g = atom.grammars.grammarForScopeName("text.tex.latex")
  if (g) {
    g.maxTokensPerLine = maxTokens
  }
}
...
module.exports = {
  ...
  activate(serialized) {
    ...
    this.disposables.add(atom.grammars.onDidAddGrammar(setMaxLines))
    return this.disposables.add(atom.config.observe('language-latex2e.maxTokensPerLine', updateMaxLines))
  },
